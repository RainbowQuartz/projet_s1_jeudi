...
def perform(x)
  ...
  puts "-" * 20
  puts "Nombre de Aude : " + aude(x).to_s
  puts "-" * 20
  puts "Nombre de journalistes dont le handle commence par une majuscule : " + majuscule(x).to_s
  puts "-" * 20
  puts "Nombre de journalistes avec des majuscules dans leur handle : " + contiens_majuscule(x).to_s
  puts "-" * 20
