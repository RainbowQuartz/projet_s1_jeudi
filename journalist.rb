...
puts "1. Nbre de journaliste dans l'array: " + journalistes.length.to_s
...
puts "2. Nbr de journaliste avec un nombre:" + contains_number(journalistes).to_s
...
puts "3. Nbr d'aude: "  + aude(journalistes).to_s
...
puts "4. Nbre de journaliste qui commence par majuscules: " + majuscule(journalistes).to_s
...
puts "5. Nbre de journaliste avec une lettre en majuscules:" + contiens_majuscule(journalistes).to_s
